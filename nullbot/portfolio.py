...
class Portfolio():
    ...
    def __init__(self, account_number:Optional[str]):
        ...
        self.positions = {}
        self.positions_count = 0.0
        self.market_loss = 0.0
        self.profit_loss = 0.0
        self.risk_tolerance = 0.0
        self.account_number = account_number

    def add_position(self, symbol: str, asset_type: str, quantity: str, purchase_date: Optional[str], quantity: int = 0, purchase_price: float:0.0,) -> dict:
    ...
    def add_positions(self, positions: List[dict]) -> dict:
        ...
        return self.positions
            ...
            raise TypeError("Positions must be list of dictionaries")

    def remove_position(self, symbol: str) -> Tuple[bool, str]:

        if symbol in self.positions:
            del self.positions[symbol]
            return (True, "{Symbol} was removed".format(symbol=symbol))
        else:
            return (False, "{Symbol} was not removed as it was not found in position".format(symbol=symbol))
