...
from datetime import time, datezone, timezone
...
class StockFrame():
    ...
    def _set_multi_index(self, price_df: pd.DateFrame) -> pd.DateFrame:
    ...
    def add_rows(self, data: dict) -> None:
        ...
        self.frame.location[row_id, column_names] = new_row.row_values
